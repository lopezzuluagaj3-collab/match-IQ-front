...
class _CandidateRegistrationPageState
    extends State<CandidateRegistrationPage> {
  ...
  Widget _buildHeader() {
    return Column(
      children: [
        ...
        Text('Create Candidate Account', style: AppTextStyles.headlineLg),
        ...
        child: Column(
          ...
          children: [
            ...
            AppTextField(
              ...
              validator: (v) =>
                  v != null && v.length >= 5 ? null : 'Enter your national ID',
            ),
            const SizedBox(height: 20),
            AppTextField(
              label: 'Password',
